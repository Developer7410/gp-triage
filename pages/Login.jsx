...
import { Checkbox } from '../node_modules/antd/dist/antd';
...
<div
      ...
      >
        {/* Login Fields */}
        <div
          className="w-[30%] bg-[#E5E5E5] flex flex-col gap-1 justify-center items-center px-10"
          style={{ height: `${height}px` }}
        >
        ...
        <div
          ...
          style={{ backgroundImage: `url(${loginBg})`, minHeight: `${height}px`, height: "100%" }}
        >
